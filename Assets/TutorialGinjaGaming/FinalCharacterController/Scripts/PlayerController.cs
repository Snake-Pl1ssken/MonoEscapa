...
using static GinjaGaming.FinalCharacterController.PlayerState;
...
namespace GinjaGaming.FinalCharacterController
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [Header("Animation")]
        public float playerModelRotation = 10f;
        ...
        private void UpdateCameraRotation()
        {
            ...
            //If rotatin mismatch not within tolerance, or rotate to target is active, ROTATE
        ...
        private void RotatePlayerToTarget()
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, targetRotationX, playerModelRotation * Time.deltaTime);
        }
        #endregion
        ...
        private bool CanRun()
        {
            //this means player is moving diagonally at 45deg or forward, if so, we can run
